...
from ..exceptions import ElfinderErrorMessages, FileNotFoundError, DirNotFoundError, PermissionDeniedError, \
...
class ElfinderVolumeDriver(object):
    ...
    def mount(self, opts):
        ...
        self._root = self._normpath(self._options['path'].encode('utf-8'))
